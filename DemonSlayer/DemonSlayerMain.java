...
import DemonSlayer.Enemies.Akaza;
import DemonSlayer.Enemies.Muzan;
import DemonSlayer.Enemies.Rui;
import DemonSlayer.MusicFiles.PlaySound;
import DemonSlayer.Slayers.Inosuke;
import DemonSlayer.Slayers.Kamado;
import DemonSlayer.Slayers.Zenitsu;
...
public class DemonSlayerMain {
    ...
    public static void main(String[]args) throws UnsupportedAudioFileException, IOException, LineUnavailableException{
        ...
        File startMenu = new File("DemonSlayer/MusicFiles/Demon Slayer Kimetsu no Yaiba the Movie - Mugen Train Ending FullLiSA - Homura.wav");
        File ruiFile = new File("DemonSlayer/MusicFiles/Gurenge.wav");
        File akazaFile = new File("DemonSlayer/MusicFiles/Demon Slayer Movie Akaza vs Rengoku Theme EPIC HQ COVER (Mugen Train OST).wav");
        File muzanFile = new File("DemonSlayer/MusicFiles/Demon Slayer Kimetsu no Yaiba ED (Ep19) Full - Kamado Tanjirou no Uta (Lyrics).wav");
        File gameOverFile = new File("DemonSlayer/MusicFiles/game over sound.wav");
        File youWinFile = new File("DemonSlayer/MusicFiles/youWin.wav");
    ...
    // Changing character healths for both slayers and demons
