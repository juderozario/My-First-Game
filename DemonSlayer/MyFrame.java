...
import DemonSlayer.MusicFiles.PlaySound;

public class MyFrame extends JFrame implements ActionListener {

    // Initialize the music variables in this class and define them in the construct
    Clip startMenuClip; Clip ruiSoundClip; Clip akazaSoundClip; Clip muzanSoundClip; Clip gameOverClip; Clip youWinClip;
    FloatControl startMenuVolume; FloatControl ruiVolume; FloatControl youWinVolume;
    FloatControl akazaVolume;  FloatControl muzanVolume; FloatControl gameOverVolume;
    
    // Initialize all buttons
    JButton play; JButton credits; JButton quit; JButton back; JButton back2;
    JButton ruiButton; JButton akazaButton; JButton muzanButton;
    JButton kamadoCharacterButton; JButton zenitsuCharacterButton; JButton inosukeCharacterButton; 
    JButton attackKamadoButton; JButton attackZenitsuButton; JButton attackInosukeButton;
    JButton evadeKamadoButton; JButton evadeZenitsuButton; JButton evadeInosukeButton;
    JButton healKamado; JButton healZenitsu; JButton healInosuke; JButton characterChoiceButton;
    
    // Initialize a panel
    JPanel panel;

    // Initialize all labels
    JLabel startBackground; JLabel title; JLabel gameOver; JLabel youWin;
    JLabel ruiBackground; JLabel akazaBackground; 
    JLabel muzanBackground; JLabel ruiBody; JLabel akazaBody; JLabel muzanBody; 
    JLabel kamadoBody; JLabel zenitsuBody; JLabel inosukeBody;
    JLabel healthKamadoLabel; JLabel healthZenitsuLabel; JLabel healthInosukeLabel;
    JLabel healthRuiLabel; JLabel healthAkazaLabel; JLabel healthMuzanLabel;
    JLabel musicCredits; JLabel characterSelect;
    
    // Get all images and resize them according to their desired width and height
    ImageIcon mainIcon = new ImageIcon("DemonSlayer/Images/icon.png");
    ImageIcon characterChoiceBackground = new ImageIcon("DemonSlayer/Images/characterChoiceButton.png");
    ImageIcon akazaImageBackground = new ImageIcon("DemonSlayer/Images/akazaBackground.png");
    ImageIcon muzanImageBackground = new ImageIcon("DemonSlayer/Images/muzanBackground.png");
    ImageIcon ruiImageBackground = new ImageIcon("DemonSlayer/Images/ruiBackground.png");
    ImageIcon thunderBackground = new ImageIcon("DemonSlayer/Images/thunderStrike.png");
    ImageIcon fireBackground = new ImageIcon("DemonSlayer/Images/fireBackground.png");
    ImageIcon waterBackground = new ImageIcon("DemonSlayer/Images/waterStrike.png");
    ImageIcon inosukeBodyImage = new ImageIcon("DemonSlayer/Images/inosuke.png");
    ImageIcon zenitsuBodyImage = new ImageIcon("DemonSlayer/Images/zenitsu.png");
    ImageIcon kamadoBodyImage = new ImageIcon("DemonSlayer/Images/tanjiro.png");
    ImageIcon GameOverIcon = new ImageIcon("DemonSlayer/Images/gameover.png");
    ImageIcon akazaBodyImage = new ImageIcon("DemonSlayer/Images/akaza.png");
    ImageIcon muzanBodyImage = new ImageIcon("DemonSlayer/Images/muzan.png");
    ImageIcon CreditsIcon = new ImageIcon("DemonSlayer/Images/credits.png");
    ImageIcon YouWinIcon = new ImageIcon("DemonSlayer/Images/youWin.png");   
    ImageIcon menuIcon = new ImageIcon("DemonSlayer/Images/menuBack.jpg");
    ImageIcon ruiBodyImage = new ImageIcon("DemonSlayer/Images/rui.png");
    ImageIcon icon = new ImageIcon("DemonSlayer/Images/logo.png");
    ...
    MyFrame(Clip ruiSoundClip, Clip akazaSoundClip, Clip muzanSoundClip, FloatControl ruiVolume, FloatControl akazaVolume, FloatControl muzanVolume, 
    Clip startMenuClip, FloatControl startMenuVolume, Clip gameOverClip, FloatControl gameOverVolume, Clip youWinClip, FloatControl youWinVolume) {
        ...
        this.add(title); this.add(play);
        this.add(credits); this.add(quit);
        this.add(back); this.add(back2);
        this.add(characterChoiceButton); 
        this.add(gameOver); this.add(youWin);
        this.add(ruiButton); this.add(akazaButton); this.add(muzanButton);
        this.add(musicCredits); this.add(panel); this.add(startBackground); 
        this.add(kamadoCharacterButton); this.add(zenitsuCharacterButton); this.add(inosukeCharacterButton);
        this.add(ruiBody); this.add(akazaBody); this.add(muzanBody);
        this.add(kamadoBody); this.add(zenitsuBody); this.add(inosukeBody); 
        this.add(attackKamadoButton); this.add(attackZenitsuButton); this.add(attackInosukeButton);
        this.add(evadeKamadoButton); this.add(evadeZenitsuButton); this.add(evadeInosukeButton);
        this.add(healKamado); this.add(healZenitsu); this.add(healInosuke);
        this.add(healthKamadoLabel); this.add(healthZenitsuLabel); this.add(healthInosukeLabel);
        this.add(healthRuiLabel);  this.add(healthAkazaLabel); this.add(healthMuzanLabel);
        this.add(ruiBackground); this.add(akazaBackground); this.add(muzanBackground);
    }
    ...
    @Override
    // This is a action scaner which waits for interaction with any button provided and perform the action according to it.
    public void actionPerformed(ActionEvent e) {
        ...
        // Go to the main menu screen with both back button
            ...
            healthXAkaza = 520;
            healthXMuzan = 500;
            DemonSlayerMain.kamado.healthTanjiro = 100;
            DemonSlayerMain.zenitsu.healthZenitsu = 100;
            DemonSlayerMain.inosuke.healthInosuke = 100;
        ...
        // If rui button is clicked open character selection and show all Rui functionalites
        ...
        // If akaza button is clicked open character selection and show all Rui functionalites
        ...
        // If muzan button is clicked open character selection and show all Rui functionalites
        ...
        // Character choice button can be used to switch characters in the middle of the match
        ...
        // Heal functionalities for all slayers
            ...
            if (DemonSlayerMain.heals == 1){ 
                ...
                DemonSlayerMain.kamado.healthTanjiro += 30;
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.kamado.healthTanjiro-30)+" to "+
                DemonSlayerMain.kamado.healthTanjiro+"hp.\nHeals left "+DemonSlayerMain.heals);
            ...
            if (DemonSlayerMain.heals == 1){ 
                DemonSlayerMain.heals--;
                DemonSlayerMain.zenitsu.healthZenitsu += 30;
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.zenitsu.healthZenitsu-30)+" to "+
                DemonSlayerMain.zenitsu.healthZenitsu+"hp.\nHeals left "+DemonSlayerMain.heals);
                healKamado.setEnabled(false);
                healZenitsu.setEnabled(false);
                healInosuke.setEnabled(false);
            ...
            if (DemonSlayerMain.heals == 1){ 
                DemonSlayerMain.heals--;
                DemonSlayerMain.inosuke.healthInosuke += 30;
                JOptionPane.showMessageDialog(null, "Health increased from "+(DemonSlayerMain.inosuke.healthInosuke-30)+" to "+
                DemonSlayerMain.inosuke.healthInosuke+"hp.\nHeals left "+DemonSlayerMain.heals);
                healKamado.setEnabled(false);
                healZenitsu.setEnabled(false);
                healInosuke.setEnabled(false);
    ...
    private void hpKamadoLabel() {
        if (boss.equals("RUI")){
            ...
            DemonSlayerMain.kamadoHealth(damage);
    ...
    private void hpZenitsuLabel(){
        if (boss.equals("RUI")){
            int damage = DemonSlayerMain.rui.dealDamage();
            damageAbsorbed = damage;
            DemonSlayerMain.zenitsuHealth(damage);
    ...
    private void hpInosukeLabel(){
        if (boss.equals("RUI")){
            int damage = DemonSlayerMain.rui.dealDamage(); 
            damageAbsorbed = damage; 
            DemonSlayerMain.inosukeHealth(damage);
    ...
    private void hpRuiLabel(){
        if (slayer.equals("KAMADO")){
            ...
            DemonSlayerMain.ruiHealth(takeDamage);
    ...
    private void hpAkazaLabel(){
        if (slayer.equals("KAMADO")){
            int takeDamage = DemonSlayerMain.kamado.dealDamage();
            DemonSlayerMain.akazaHealth(takeDamage);
    ...
    private void hpMuzanLabel(){
        if (slayer.equals("KAMADO")){
            ...
            DemonSlayerMain.muzanHealth(takeDamage);
    ...
    private boolean allSlayerDeath(){
        int[] slayersHealth = {DemonSlayerMain.kamado.getHealth(), DemonSlayerMain.zenitsu.getHealth(), DemonSlayerMain.inosuke.getHealth()};
    ...
    private void showKamadoIf(){
        if (DemonSlayerMain.kamado.healthTanjiro > 0){
            kamadoBody.setVisible(true);
            kamadoCharacterButton.setVisible(true);
            kamadoBody.setBounds(70,0,800,600);
        }
    ...
    private void showZenitsuIf(){
        if (DemonSlayerMain.zenitsu.healthZenitsu > 0){
            zenitsuBody.setBounds(290,0,800,600);
            zenitsuBody.setVisible(true);
            zenitsuCharacterButton.setVisible(true);
        }
    ...
    private void showInosukeIf(){
        if (DemonSlayerMain.inosuke.healthInosuke > 0){
            inosukeBody.setBounds(510,0,800,600);
            inosukeBody.setVisible(true);
            inosukeCharacterButton.setVisible(true);
        }
        ...
        if (boss.equals("RUI")){
            ...
            timer.schedule(new TimerTask(){
                ...
                public void run() {
                    ...
                    attackZenitsuButton.setEnabled(true);
                    if (DemonSlayerMain.zenitsu.healthZenitsu <= 0 && !allSlayerDeath()){
                        boss = "RUI";
                        zenitsuBody.setVisible(false);
                        healthZenitsuLabel.setVisible(false);
                        attackZenitsuButton.setVisible(false);
        ...
        if (boss.equals("RUI")){
            ...
            timer.schedule(new TimerTask(){
                ...
                public void run() {
                    ...
                    if (DemonSlayerMain.inosuke.healthInosuke <= 0 && !allSlayerDeath()){
                        boss = "RUI";
                        inosukeBody.setVisible(false);
                        healthInosukeLabel.setVisible(false);
                        attackInosukeButton.setVisible(false);
    ...
    private void evadeKamado(){
        if (boss.equals("RUI"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.kamado.printStatsEvade()+
            "\n"+DemonSlayerMain.rui.toString());        
        else if (boss.equals("AKAZA"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.kamado.printStatsEvade()+
            "\n"+DemonSlayerMain.akaza.toString()); 
    ...
    private void evadeZenitsu(){
        if (boss.equals("RUI"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.zenitsu.printStatsEvade()+
            "\n"+DemonSlayerMain.rui.toString());    
        else if (boss.equals("AKAZA"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.zenitsu.printStatsEvade()+
            "\n"+DemonSlayerMain.akaza.toString());
    ...
    private void evadeInosuke(){
        if (boss.equals("RUI"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.inosuke.printStatsEvade()+
            "\n"+DemonSlayerMain.rui.toString());
        else if (boss.equals("AKAZA"))
            JOptionPane.showMessageDialog(null, DemonSlayerMain.inosuke.printStatsEvade()+
            "\n"+DemonSlayerMain.akaza.toString());    
