...
public class MyFrame extends JFrame implements ActionListener {
    ...
    ImageIcon mainIcon = new ImageIcon("bin/Images/icon.png");
    ImageIcon characterChoiceBackground = new ImageIcon("bin/Images/characterChoiceButton.png");
    ImageIcon akazaImageBackground = new ImageIcon("bin/Images/akazaBackground.png");
    ImageIcon muzanImageBackground = new ImageIcon("bin/Images/muzanBackground.png");
    ImageIcon ruiImageBackground = new ImageIcon("bin/Images/ruiBackground.png");
    ImageIcon thunderBackground = new ImageIcon("bin/Images/thunderStrike.png");
    ImageIcon fireBackground = new ImageIcon("bin/Images/fireBackground.png");
    ImageIcon waterBackground = new ImageIcon("bin/Images/waterStrike.png");
    ImageIcon inosukeBodyImage = new ImageIcon("bin/Images/inosuke.png");
    ImageIcon zenitsuBodyImage = new ImageIcon("bin/Images/zenitsu.png");
    ImageIcon kamadoBodyImage = new ImageIcon("bin/Images/tanjiro.png");
    ImageIcon GameOverIcon = new ImageIcon("bin/Images/gameover.png");
    ImageIcon akazaBodyImage = new ImageIcon("bin/Images/akaza.png");
    ImageIcon muzanBodyImage = new ImageIcon("bin/Images/muzan.png");
    ImageIcon CreditsIcon = new ImageIcon("bin/Images/credits.png");
    ImageIcon YouWinIcon = new ImageIcon("bin/Images/youWin.png");   
    ImageIcon menuIcon = new ImageIcon("bin/Images/menuBack.jpg");
    ImageIcon ruiBodyImage = new ImageIcon("bin/Images/rui.png");
    ...
    @Override
    // This is a action scanner which waits for interaction with any button provided and perform the action according to it.
